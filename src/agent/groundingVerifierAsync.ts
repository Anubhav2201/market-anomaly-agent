import { ExplanationGenerated, GroundingVerified, DomainEvent, EventId } from "../events/types";
...
export class AsyncGroundingVerifier {
  ...
  private fail(explanation: ExplanationGenerated, reason: string): GroundingVerified {
    return {
      type: "GroundingVerified",
      event_id: uuidv4(),
      ticker: explanation.ticker,
